...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(com.asd.service.ActivoFijoFacadeREST.class);
        resources.add(com.asd.service.AreaFacadeREST.class);
        resources.add(com.asd.service.CiudadFacadeREST.class);
        resources.add(com.asd.service.EstadoActivoFijoFacadeREST.class);
        resources.add(com.asd.service.PersonaFacadeREST.class);
        resources.add(com.asd.service.TipoActivoFacadeREST.class);
